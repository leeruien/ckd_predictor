...
with torch.no_grad():  
    for inputs, labels in test_loader:
        ...
        y_true.extend(labels.tolist())  # Convert tensor to list and extend y_true
        y_pred.extend(predicted.tolist())  # Convert tensor to list and extend y_pred


# Now y_true and y_pred contain all true and predicted labels
print("True labels:", y_true)
print("Predicted labels:", y_pred) 
print("Neural Network Accuracy:", accuracy_score(y_true, y_pred))
